...
CAN_OBJECTS = [
    ...
    {'name': 'BoostKey', 'type': 'multi', 'levels': 2, 'key_number': 0x04, 'mode': 'latch', 'led_colors': {0: 0x00, 1: 0x03, 2: 0x06}, 'forward_address': 0x07C, 'forward_messages': {0: b'\x00\x00', 1: (250 * 10).to_bytes(2, byteorder='little'), 2: (300 * 10).to_bytes(2, byteorder='little')}},  # off, blue, magenta
